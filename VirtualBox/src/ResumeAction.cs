...
namespace VirtualBox
{
	...
	public class ResumeVM : Act
	{
		...
		public override string Name {
			get { return AddinManager.CurrentLocalizer.GetString("Resume Virtual Machine"); }
		}

		public override string Description {
			get { return AddinManager.CurrentLocalizer.GetString("Resume the selected Virtual Machine"); }
		}
