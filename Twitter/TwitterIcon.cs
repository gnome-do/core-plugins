/* TwitterIcon.cs
 *
 * This file provides a method for caching icons for the twitter plugin.
 *
...
{
	/// <summary>
	/// Singleton class for saving and storing icons.
	...
	class TwitterIcons
	{
		public static TwitterIcons instance = null;
		private Dictionary<string, string> iconcache;
		Assembly asm;

		private TwitterIcons()
		{
			iconcache = new Dictionary<string, string>();
			asm = Assembly.GetExecutingAssembly();
		}

		public static TwitterIcons Instance
		{
			get
			{
				if (instance == null)
				{
					instance = new TwitterIcons();
				}
				return instance;
			}
		}
